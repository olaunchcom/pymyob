...
class PartnerCredentials:
    ...
    def __init__(
        ...
        # MYOB now requires an explicit scope. Honour the supplied scope (space-separated
        # for the new granular data scopes), URL-encoding it, and fall back to the legacy
        # "CompanyFile" scope when none is provided.
